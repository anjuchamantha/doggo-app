...
class AppColors {
  ...
  static const Color darkBlue = Color(0xff081C48);
  static const Color littledarkBlue = Color(0xaf081C48);
  static const Color topBlack = Color(0xff1a1a1a);
  static const Color gold = Color(0xffa58650);
